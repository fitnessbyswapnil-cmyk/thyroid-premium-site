...
import DecodeStickyCta from "@/app/decode/DecodeStickyCta";
import ShareWithFamily from "@/app/decode/ShareWithFamily";

/**
 * /decode-long — BACKUP of the long /decode page as it ran until 14-Sep-2026.
 *
 * Kept so the ads can be pointed back here in one change if the short page
 * books fewer calls. Not linked from anywhere and not indexed. Everything below
 * this note is the original page, unchanged.
 *
...
export default function DecodeLongPage() {
  return (
