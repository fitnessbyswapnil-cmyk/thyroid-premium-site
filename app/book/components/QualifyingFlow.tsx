...
function ProgressBar({ pct }: { pct: number }) {
  ...
  return (
    <div className="mb-6 w-full">
      ...
      <div className="mb-2.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-[0.6rem] font-semibold uppercase tracking-[0.12em] text-[#857c6d]">
        <span>Personalised</span>
        <span aria-hidden className="text-[#9c9384]">·</span>
...
export default function QualifyingFlow() {
  ...
  return (
    <div className="mx-auto w-full max-w-[580px] px-5">
        ...
        >
          ...
          {step.type === "intro" && (
            <div className="py-6 text-center">
              ...
              <p className="mb-4 text-[0.66rem] font-bold uppercase tracking-[0.22em] text-[#a07c33]/80">
              ...
              <p className="mt-4 text-[0.72rem] text-[#857c6d]">Your slot is reserved · 2 minutes, then pick your time</p>
            </div>
          )}
          ...
          {step.type === "scale" && (
            <>
              ...
              <div className="mt-2 flex justify-between text-[0.72rem] text-[#857c6d]">
          ...
          {(step.type === "text" || step.type === "tel" || step.type === "email") && (
            <div className="mt-7">
              ...
              />
              {step.id === "name" && (
                <p className="-mt-1 text-[0.74rem] leading-relaxed text-[#857c6d]">
      ...
      {enterAdvances && (
        <p className="pointer-events-none fixed bottom-4 right-4 z-20 hidden text-[0.68rem] text-[#857c6d] sm:block">
          Press Enter ↵
        </p>
      )}
    </div>
