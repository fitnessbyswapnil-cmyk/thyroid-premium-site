  ...
  return (
    <div className="space-y-5">
      ...
      <motion.p
        ...
        className="text-center text-[0.62rem] font-bold uppercase tracking-[0.22em] text-[#96661a]"
      >
      ...
      <motion.div
        ...
        className="rounded-[24px] border border-[#ddd4c6] bg-white p-6 text-center backdrop-blur-xl"
      >
        <h2 className="mb-3 text-[1.55rem] font-black leading-[1.1] tracking-[-0.04em] text-[#241f1a]">
          Your Thyroid Consultation{" "}
          <span className="bg-gradient-to-r from-[#96661a] to-[#a37220] bg-clip-text text-transparent">
        ...
        <p className="mt-2 text-[0.82rem] font-medium leading-relaxed text-[#423b33]">
      ...
      <motion.div
        ...
        className="rounded-[28px] border border-[#a37220]/35 bg-gradient-to-b from-[#a37220]/[0.08] to-transparent p-6 shadow-[0_20px_70px_rgba(36, 31, 26,0.14)] backdrop-blur-2xl"
      >
        {/* Session line */}
        <div className="mb-5 flex items-center justify-between rounded-2xl border border-[#ddd4c6] bg-white px-4 py-4">
          <div>
            <p className="text-[0.88rem] font-semibold text-[#241f1a]">
          ...
          <div className="text-right">
            <p className="bg-gradient-to-r from-[#96661a] to-[#a37220] bg-clip-text text-[1.5rem] font-black text-transparent">
              ₹299
            </p>
        ...
        <button
          ...
          onClick={onPay}
          disabled={loading}
          className="group mb-4 w-full overflow-hidden rounded-2xl bg-gradient-to-r from-[#96661a] to-[#8a5d12] px-5 py-5 shadow-[0_10px_40px_rgba(150, 102, 26,0.4)] transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_14px_50px_rgba(150, 102, 26,0.5)] active:scale-[0.99] disabled:opacity-70"
          ...
          {loading ? (
            <>
              <div className="flex items-center justify-center gap-2">
                <svg
                  className="h-4 w-4 animate-spin text-[#423b33]"
                  viewBox="0 0 24 24"
                  fill="none"
                >
              ...
              <div className="mt-1 text-[0.72rem] text-[#6b6157]">Please wait, do not close this page</div>
            </>
          ) : (
            <>
              ...
              <div className="mt-1 text-[0.72rem] text-[#423b33]">
        ...
        <ul className="mb-4 space-y-1.5">
          {CTA_BULLETS.map((b) => (
            <li key={b} className="flex items-center gap-2 text-[0.75rem] text-[#6b6157]">
      ...
      >
        ...
        <div className="space-y-2.5">
          {WHAT_NEXT.map((step) => (
            <div
              key={step.num}
              className="flex gap-4 rounded-2xl border border-[#ddd4c6] bg-white p-4"
            >
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-[#a37220]/30 bg-[#a37220]/10 text-[0.65rem] font-bold text-[#8a5d12]">
                {step.num}
              </div>
              <div>
                <p className="text-[0.84rem] font-semibold text-[#241f1a]">{step.title}</p>
      ...
      >
        {TRUST_ITEMS.map((item) => (
          <div
            key={item.label}
            className="flex flex-col items-center gap-1.5 rounded-2xl border border-[#ddd4c6] bg-white py-3.5"
          >
