...
// TEST MODE — ON (2026-09-12, owner testing the commitment question, the
// timing gate and the partner confirmation; ads paused). While true, Cashfree charges Rs 1 while
