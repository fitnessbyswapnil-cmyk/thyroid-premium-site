...
// TEST MODE — OFF. Last used 2026-09-11 for Rs 1 payment tests of the
// Cloudflare host. While true, Cashfree charges Rs 1 while every visible price
// still reads Rs 299, and the Purchase value Meta receives is 1. It MUST be
// false whenever an ad points at the funnel: the last time it was left on it
// cost roughly Rs 900/day uncollected.
