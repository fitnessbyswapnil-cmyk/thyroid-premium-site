...
const results = [
  {
    name: "Vaidehi S., 34",
    badges: ["4.8 kg Lost", "2 Inch Waist ↓", "Energy Restored", "Less Bloating"],
    quote: "I lost more in 6 weeks than in 2 years of trying alone.",
    img: "/transformations/Vaidehi 1.png",
  },

  {
    name: "Surekha P., 41",
    badges: ["3.5 kg Lost", "Clothes Fitting", "Belly Fat ↓", "Confidence Back"],
  ...
  {
    name: "Nehamia R., 38",
    badges: ["5.2 kg Lost", "3 Inch Loss", "Brain Fog Gone", "Sleep Improved"],
  ...
  {
    name: "Kishore K., 45",
    badges: ["4.1 kg Lost", "Bloating Gone", "Energy Up", "Cravings Reduced"],
    quote: "No starvation. Real food. Real results.",
    img: "/transformations/Kishore 4.png",
  },
];
