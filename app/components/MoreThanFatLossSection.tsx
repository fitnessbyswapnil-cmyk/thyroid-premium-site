...
const stories = [
  ...
  // Removed Priya K. & Kavita R. — duplicate placeholder photos
  // (they reused surekha.png / heenal.png, so two clients shared one face).
  // Re-add when real distinct images are available.
];
